...
- Create Angular project with ng: `ng new incometaxcalculator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`incometaxcalculator.client.esproj`).
